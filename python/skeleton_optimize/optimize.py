...
#     unity_landmark[13, 1] = (kpt3d[12, 1] + kpt3d[11, 1]) / 2 + (
#                 unity_landmark[12, 1] - (kpt3d[12, 1] + kpt3d[11, 1]) / 2) / 0.372
#     # -left-eye:14
...
if __name__ == "__main__":
    ...
    a = [1, 2, 3, 4, 5, 6, 7, 8]
    y = [np.array([[1, 3, 4], [3, 4, 6], [5, 4, 6]]), np.array([[2, 3, 5], [3, 3, 2], [3, 4, 5]]),
         np.array([[1, 2, 4], [3, 1, 2], [2, 3, 6]]), np.array([[1, 3, 5], [2, 4, 6], [5, 1, 2]]),
         np.array([[2, 1, 4], [3, 4, 6], [5, 4, 6]]), np.array([[1, 3, 5], [3, 4, 6], [5, 4, 6]]),
         np.array([[1, 2, 2], [2, 2, 6], [5, 4, 6]]), np.array([[4, 1, 2], [1, 2, 1], [4, 4, 1]])]
    query_t = 9
    smooth_range = 10
